...
const T = {
  dz: {
    dir: "rtl" as const,
    nav: { features: "لمزايا", how: "كيفاش تخدم", integrations: "الإنتيغراسيون", pricing: "الثمن", login: "دخل", cta: "ابدا مجانا" },
    hero: {
      badge: "مبني للتجارة الإلكترونية الجزائرية",
      h1a: "بيع أكثر.", h1b: "تهتم أقل.",
      sub: "داشبورد واحدة لكل كوموندتك، شاتبوت AI يهضر دارجة، وسويفي ليفريزون ليف — مبني للبياعين الجادين.",
      cta: "ابدا بلا فلوس", demo: "شوف ديمو", note: "مجاني · بلا كارط بنكية",
    },
    logos: "التجار الجزائريين يثقوا فيه · متكامل مع",
    features: {
      tag: "لمزايا", h: "كل أداة تحتاجها تبيع أكثر",
      sub: "وقفوا تبدلوا بين 5 تطبيقات. فلاود تجمع كل شي باش تركزوا على البيع.",
      cards: [
        { icon: "🤖", title: "شاتبوت AI بالدارجة", desc: "الـAI ديالك يرد على لعميل بالدارجة، الفرنسية ولا الإنجليزية — بصوتك وكطالوقك. يأخد كوموندات، يرد على السوالات، وما ينعسش." },
        { icon: "📊", title: "داشبورد الكوموندات", desc: "الكوموندات من إنستغرام، ماسنجر، شوبيفاي ولا مانويل — كلها في تابل واحدة. فيلتري، كونفيرمي، وشوت بالباتش بلا ما تبدل تابس." },
        { icon: "🚚", title: "سويفي الليفريزون ليف", desc: "كونيكتي يالدين، ZR إكسبريس، مايسترو، وإيدي آب. سويفيوا كل كوليس ليف وتعرفوا بيه في لوقت لي يصل ولا يتحبس." },
        { icon: "⚡", title: "صفحات المنتج AI", desc: "شارجي فوتو منتج وGemini AI تجنيري ليك بيج كاملة في 30 ثانية. شارك اللينك — الكوموندات تجيك وحدها." },
        { icon: "🔗", title: "كل القنوات، مكونيكتي", desc: "إنستغرام DMs، ماسنجر، واتساب، شوبيفاي، ووكومرس، قوقل شيتس — ويبهوك واحدة، كل شي يدخل في فلاود وحده." },
        { icon: "👥", title: "التيم والبيرميسيون", desc: "إنفيتي أجونت، كونفيرماتور، وأدمين ببيرميسيون مدروسة. مبني للتيمات لي تكبر بسرعة وتبقى منظمة." },
      ],
    },
    how: {
      tag: "كيفاش تخدم", h: "من الـDM للليفريزون — في فلو واحدة",
      steps: [
        { title: "العميل يبعت DM", desc: "عميل يكلمك على إنستغرام ولا ماسنجر. الـAI ديال فلاود يتعرف على اللغة ويرد في الحين — بلا تأخير، بلا رسائل ضايعة." },
        { title: "الـAI يأخد الكوموند", desc: "لشاتبوت يأخد المنتج، الكمية، الولاية، والكونتاكت — ويدير كوموندة مكونفيرمية في الداشبورد ديالك أوتوماتيك." },
        { title: "ترسل بكليك واحدة", desc: "اختار يالدين، ZR إكسبريس، مايسترو ولا إيدي آب وترسل. ID ديال التراكينق يتجنيري ويتربط بالكوموند في الحال." },
        { title: "سويفيوا كل شي ليف", desc: "شوفوا كل كوليس على كل الكاريار في تابل واحدة. تعرفوا في لوقت لي يصل ولا يحتاج لانتباه." },
      ],
    },
    integrations: { tag: "الإنتيغراسيون", h: "كونيكتي كل ستاك ديالك", sub: "كل بلاتفورم لي كتخدم بيه ديجا، مكونيكت مع فلاود في قليل دقايق." },
    pricing: {
      tag: "الثمن", h: "أسعار بسيطة، بلا خبية", sub: "كل الأسعار بالدينار الجزائري. بلا رسوم مخفية. تكانسل امتى تحب.",
      plans: [
        { name: "Starter", price: "مجاني", period: "/ شهر", tagline: "باش تبدا وتجرب لبلاتفورم.", features: ["حتى 100 كوموندة / شهر", "قناة واحدة (إنستغرام ولا ماسنجر)", "شاتبوت AI (محدود)", "شركة ليفريزون واحدة"], btn: "ابدا مجانا", btnStyle: "outline", popular: false },
        { name: "Growth", price: "4 900", period: "دج / شهر", tagline: "للبياعين الأكتيف لي يبغوا يسكالوا.", features: ["كوموندات غير محدودة", "كل القنوات مكونيكتي", "شاتبوت AI كامل (دارجة، FR، EN)", "كل شركات الليفريزون", "صفحات المنتج AI", "تيم حتى 5 أعضاء"], btn: "تجربة مجانية 14 يوم", btnStyle: "solid", popular: true },
        { name: "Pro", price: "9 900", period: "دج / شهر", tagline: "للتيمات والعمليات متعددة المتاجر.", features: ["كل لي في Growth", "مولتي-ووركسبيس", "أعضاء تيم غير محدودين", "ساپور أولوية", "بيرسونا شاتبوت مخصص"], btn: "اتصل بينا", btnStyle: "outline", popular: false },
      ],
    },
    testimonials: {
      tag: "الشهادات", h: "البياعين يحبو فلاود",
      cards: [
        { quote: '"الشاتبوت AI يهضر الدارجة بحالي أنا. العملاء ماعرفوش حتى أنو بوت. الكوموندات زادوا بـ40% في الشهر الأول."', name: "Sofia Amrani", meta: "بوتيك الموضة · الجزائر", initials: "SA", color: "#0052FF" },
        { quote: '"كنت دير 3 تابلور و4 تطبيقات. دابا كل شي في فلاود. نشوف كل كوموندة، كل كوليس، في شي واحدة. عجباتلي الحياة."', name: "Karim Moussa", meta: "الإلكترونيك · وهران", initials: "KM", color: "#0EA5E9" },
        { quote: '"صفحات المنتج AI وحدها تحلا الأبونمان. 30 ثانية باش تعمل بيج كاملة من فوتو واحدة."', name: "Nadia Benmoussa", meta: "الكوزماتيك · قسنطينة", initials: "NB", color: "#F97316" },
      ],
    },
    cta: { badge: "انضم لمئات البياعين الجزائريين", h1: "ديروا كل شي من", h2: "شي واحدة.", sub: "بلا كارط بنكية. بلا إلتزام. غير أكثر بيع وأقل ستريس.", btn: "ابدا مجانا", demo: "شوف كيفاش تخدم" },
    footer: { copy: "© 2026 Flowd · مبني للتجارة الإلكترونية الجزائرية", links: ["السرية", "الشروط", "اتصل بينا"] },
  },
  fr: {
